...
partial class ParkoutPainters
{
	...
	public static class Events
	{
		...
		/// </summary>
		internal const string EnterGameState = "ParkoutPainters_entergamestate";
		/// <summary>
		...
		/// </summary>
		internal const string ExitGameState = "ParkoutPainters_exitgamestate";
		/// <summary>
		...
		/// </summary>
		internal const string GraffitiSpotTampered = "ParkoutPainters_graffitispottampered";
		/// <summary>
		...
		/// </summary>
		internal const string GraffitiSpotCompleted = "ParkoutPainters_graffitispotcompleted";
