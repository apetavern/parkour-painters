...
public sealed partial class AirMoveMechanic : ControllerMechanic
{
	...
	protected override void Simulate()
	{
		...
		if ( Input.Pressed( InputAction.Jump ) && Player.WallJumpMechanic.TimeSinceLeftWall < 0.2f && !Player.WallJumpMechanic.UsedWallJump && !Player.LedgeGrabMechanic.IsActive )
