...
PS
{
	...
	TextureAttribute( LightSim_DiffuseAlbedoTexture, g_tTintMask )
	TextureAttribute( RepresentativeTexture, g_tTintMask )
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float4 l_13 = Tex2DS( g_tNormal, g_sSampler0, l_2 );
		float3 l_14 = DecodeNormal( l_13.xyz );
		float4 l_15 = Tex2DS( g_tRoughness, g_sSampler0, l_2 );
		float4 l_16 = Tex2DS( g_tMetallic, g_sSampler0, l_2 );
