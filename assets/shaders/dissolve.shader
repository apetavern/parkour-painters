...
PS
{
	...
	float2 g_vTexCoordScale < UiGroup( "Texture Coordinates,4/,0/0" ); Default2( 1,1 ); Range2( 0,0, 1,1 ); >;
	float2 g_vTexCoordOffset < UiGroup( "Texture Coordinates,4/,0/1" ); Default2( 0,0 ); Range2( 0,0, 1,1 ); >;
