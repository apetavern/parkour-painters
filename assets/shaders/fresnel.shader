...
PS
{
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float l_2 = dot( i.vNormalWs, l_1 );
		float l_3 = lerp( 1, 0, l_2 );
		float l_4 = g_flRemapInMin;
		float l_5 = saturate( ( l_3 - l_4 ) / ( 1 - l_4 ) ) * ( 1 - 0 ) + 0;
		float l_6 = g_flEmissionStrength;
		float l_7 = l_5 * l_6;
		float4 l_8 = l_0 * float4( l_7, l_7, l_7, l_7 );
		float l_9 = l_0.a * l_5;
